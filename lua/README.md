# ChuckNorrisJokes Lua SDK



The Lua SDK for the ChuckNorrisJokes API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/chuck-norris-jokes-sdk/releases)),
...
| --- | --- | --- |
| `categories` | `table` | Categories associated with the joke |
...
```
lua/
├── chuck-norris-jokes_sdk.lua    -- Main SDK module
...
The main module (`chuck-norris-jokes_sdk`) exports the SDK constructor
