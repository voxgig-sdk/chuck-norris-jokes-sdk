...
describe("CategoryEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CHUCK_NORRIS_JOKES_TEST_CATEGORY_ENTID JSON to run live")
      return
    end
...
function category_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CHUCK_NORRIS_JOKES_TEST_CATEGORY_ENTID")
  ...
  if env["CHUCK_NORRIS_JOKES_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["CHUCK_NORRIS_JOKES_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
