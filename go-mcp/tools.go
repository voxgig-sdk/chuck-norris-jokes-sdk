...
type Args struct {
	Entity string         `json:"entity" jsonschema:"category | joke | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ChuckNorrisJokesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "chuck-norris-jokes_list",
		Description: "List records from ChuckNorrisJokes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "chuck-norris-jokes_load",
		Description: "Load a single record from ChuckNorrisJokes. " +
...
func runOp(client *sdk.ChuckNorrisJokesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ChuckNorrisJokesSDK, name string) (sdk.ChuckNorrisJokesEntity, error) {
