...
// ChuckNorrisJokes SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ChuckNorrisJokesTransformResponse
{
    public static function call(ChuckNorrisJokesContext $ctx): mixed
    {
        ...
        $transform = ChuckNorrisJokesHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
