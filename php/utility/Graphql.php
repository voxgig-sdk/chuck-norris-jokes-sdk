...
// ChuckNorrisJokes SDK utility: graphql
//
...
class ChuckNorrisJokesGraphql
{
    ...
    // equivalent.
    public static function body(ChuckNorrisJokesContext $ctx): mixed
    {
    ...
    public static function errors(ChuckNorrisJokesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
