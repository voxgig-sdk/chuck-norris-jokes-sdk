...
// ChuckNorrisJokes SDK utility: fetcher

class ChuckNorrisJokesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ChuckNorrisJokesSDK/1.0)';
    ...
    public static function call(ChuckNorrisJokesContext $ctx, string $fullurl, array $fetchdef): array
    {
