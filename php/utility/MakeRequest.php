...
// ChuckNorrisJokes SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ChuckNorrisJokesMakeRequest
{
    public static function call(ChuckNorrisJokesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ChuckNorrisJokesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ChuckNorrisJokesResponse($fetched);
        } else {
