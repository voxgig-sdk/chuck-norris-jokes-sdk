...
// ChuckNorrisJokes SDK audit feature
...
class ChuckNorrisJokesAuditFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    private function _emit(ChuckNorrisJokesContext $ctx, string $outcome): void
    {
