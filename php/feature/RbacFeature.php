...
// ChuckNorrisJokes SDK rbac feature
...
class ChuckNorrisJokesRbacFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    private function _required(ChuckNorrisJokesContext $ctx): ?string
    {
    ...
    private function _reject(ChuckNorrisJokesContext $ctx, string $required): void
    {
    ...
    private function _track(ChuckNorrisJokesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
