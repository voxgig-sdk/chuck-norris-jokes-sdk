...
// ChuckNorrisJokes SDK streaming feature
...
class ChuckNorrisJokesStreamingFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    private function _iterate(ChuckNorrisJokesResult $result): \Generator
    {
    ...
    private function _streamable(ChuckNorrisJokesContext $ctx): bool
    {
