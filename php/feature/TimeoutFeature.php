...
// ChuckNorrisJokes SDK timeout feature
...
class ChuckNorrisJokesTimeoutFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    private function _with_timeout(ChuckNorrisJokesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ChuckNorrisJokesContext $_ctx, float $ms): void
    {
        $client = $this->client;
