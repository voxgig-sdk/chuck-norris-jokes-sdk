...
// ChuckNorrisJokes SDK idempotency feature
...
class ChuckNorrisJokesIdempotencyFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    private function _mutating(ChuckNorrisJokesContext $ctx): bool
    {
