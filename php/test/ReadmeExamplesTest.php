...
// ChuckNorrisJokes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ChuckNorrisJokesSDK::test)
...
{
    private const SDK_CLASS = 'ChuckNorrisJokesSDK';
    ...
    private const SDK_BASE = 'chucknorrisjokes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../chucknorrisjokes_sdk.php';
