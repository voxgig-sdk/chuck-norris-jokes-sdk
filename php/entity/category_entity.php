...
class CategoryEntity
{
    ...
    {
        if ($args) {
            $this->_data = ChuckNorrisJokesHelpers::to_map(Struct::clone($args)) ?? [];
    ...
    {
        if ($args) {
            $this->_match = ChuckNorrisJokesHelpers::to_map(Struct::clone($args)) ?? [];
     ...
     *   the SDK boundary; throws ChuckNorrisJokesError on failure (item-5 convention).
     */
