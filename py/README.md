# ChuckNorrisJokes Python SDK



The Python SDK for the ChuckNorrisJokes API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/chuck-norris-jokes-sdk/releases)) or
...
```
py/
├── chucknorrisjokes_sdk.py         -- Main SDK module
