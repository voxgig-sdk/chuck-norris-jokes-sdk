...
class ChuckNorrisJokesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ChuckNorrisJokesTestRunner.getenv("CHUCK_NORRIS_JOKES_TEST_LIVE")
        override = ChuckNorrisJokesTestRunner.getenv("CHUCK_NORRIS_JOKES_TEST_OVERRIDE")
        ...
        explain = ChuckNorrisJokesTestRunner.getenv("CHUCK_NORRIS_JOKES_TEST_EXPLAIN")
...
def entity_data(v):
    return ChuckNorrisJokesTestRunner.entity_data(v)
...
def live_client_options():
    return ChuckNorrisJokesTestRunner.live_client_options()
