# ChuckNorrisJokes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ChuckNorrisJokesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ChuckNorrisJokesSDK(...) and ChuckNorrisJokesSDK.test(...) become
#      ChuckNorrisJokesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "chucknorrisjokes_sdk"
_SDK_CLASS = "ChuckNorrisJokesSDK"
