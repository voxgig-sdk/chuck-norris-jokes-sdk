...
from chucknorrisjokes_sdk.utility import register

# Load features
from chucknorrisjokes_sdk.feature.base_feature import ChuckNorrisJokesBaseFeature
from chucknorrisjokes_sdk.features import _has_feature, _make_feature
...
class ChuckNorrisJokesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ChuckNorrisJokesUtility()
        self._utility = utility

        from chucknorrisjokes_sdk.config import shared_config
    ...
    def get_utility(self):
        return ChuckNorrisJokesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ChuckNorrisJokesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Category(self, data=None) -> "CategoryEntity":
        ...
        from chucknorrisjokes_sdk.entity.category_entity import CategoryEntity
        return CategoryEntity(self, data)


    def Joke(self, data=None) -> "JokeEntity":
        """Entity factory: client.Joke().list() / client.Joke().load({"id": ...})."""
        from chucknorrisjokes_sdk.entity.joke_entity import JokeEntity
        return JokeEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from chucknorrisjokes_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ChuckNorrisJokesSDK":
        if sdkopts is None:
            sdkopts = {}
