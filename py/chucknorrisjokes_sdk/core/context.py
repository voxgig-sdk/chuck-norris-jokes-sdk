...
from chucknorrisjokes_sdk.core.control import ChuckNorrisJokesControl
...
from chucknorrisjokes_sdk.core.helpers import get_ctx_prop, to_map
...
class ChuckNorrisJokesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ChuckNorrisJokesControl()
        ...
        if isinstance(sp, ChuckNorrisJokesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ChuckNorrisJokesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ChuckNorrisJokesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ChuckNorrisJokesOperation({})
    ...
    def make_error(self, code, msg):
        return ChuckNorrisJokesError(code, msg, self)
