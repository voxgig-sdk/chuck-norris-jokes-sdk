# ChuckNorrisJokes TypeScript SDK



The TypeScript SDK for the ChuckNorrisJokes API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/chuck-norris-jokes-sdk/releases](https://github.com/voxgig-sdk/chuck-norris-jokes-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `ChuckNorrisJokesSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ChuckNorrisJokesSDK.test(testopts?, sdkopts?)` | `ChuckNorrisJokesSDK` | Create a test-mode client. |
...
| `client` | `client(): ChuckNorrisJokesSDK` | Return the parent SDK client. |
...
chuck-norris-jokes/
├── src/
│   ├── ChuckNorrisJokesSDK.ts        # Main SDK class
