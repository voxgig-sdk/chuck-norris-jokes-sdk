# ChuckNorrisJokes TypeScript SDK Reference

Complete API reference for the ChuckNorrisJokes TypeScript SDK.
...
```ts
new ChuckNorrisJokesSDK(options?: object)
```
...
#### `ChuckNorrisJokesSDK.test(testopts?, sdkopts?)`
...
**Returns:** `ChuckNorrisJokesSDK` instance in test mode.
...
Alias for `ChuckNorrisJokesSDK.test()`.
...
Return the parent `ChuckNorrisJokesSDK` instance.
