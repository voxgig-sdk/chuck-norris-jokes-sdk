...
(0, node_test_1.describe)('SearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ChuckNorrisJokesSDK({
...
function liveScenariosActive() { return false && process.env.CHUCK_NORRIS_JOKES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'CHUCK_NORRIS_JOKES_TEST_SEARCH_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.ChuckNorrisJokesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CHUCK_NORRIS_JOKES_TEST_SEARCH_ENTID'];
    ...
    const client = new __1.ChuckNorrisJokesSDK({
        base: 'http://localhost:8080',
