// Command ChuckNorrisJokes-cli is a CLI + REPL for the ChuckNorrisJokes SDK,
...
const prompt = "chuck-norris-jokes"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "category joke search"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      CHUCK_NORRIS_JOKES_APIKEY (api key), CHUCK_NORRIS_JOKES_BASE (base url override)")
