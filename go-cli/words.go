...
func registerSDKWords(r *eng.Registry, client *sdk.ChuckNorrisJokesSDK) {
...
func runOp(client *sdk.ChuckNorrisJokesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
