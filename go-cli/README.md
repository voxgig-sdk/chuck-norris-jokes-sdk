...
AQL-driven CLI and REPL for the ChuckNorrisJokes SDK. Positional arguments are
...
```sh
go build -o chuck-norris-jokes-cli ./...
```
...
./chuck-norris-jokes-cli load 1 category
./chuck-norris-jokes-cli load '{id:1}' category
