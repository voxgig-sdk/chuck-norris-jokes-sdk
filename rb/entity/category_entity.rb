# ChuckNorrisJokes SDK Category entity
...
class CategoryEntity
  ...
  def data_set(args)
    if args
      @_data = ChuckNorrisJokesHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = ChuckNorrisJokesHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Category>, Array] the matching Category items; raises ChuckNorrisJokesError on failure
