...
#      offline in seeded test mode (ChuckNorrisJokesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ChuckNorrisJokes_sdk.rb")
  SDK_CLASS = "ChuckNorrisJokesSDK"
