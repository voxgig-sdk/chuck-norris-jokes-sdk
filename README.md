...
This is an unofficial SDK for the Chuck Norris Jokes public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/chuck-norris-jokes` | `npm install @voxgig-sdk/chuck-norris-jokes` |
| Python | `voxgig-sdk-chuck-norris-jokes` | `pip install voxgig-sdk-chuck-norris-jokes` |
| PHP | `voxgig-sdk/chuck-norris-jokes` | `composer require voxgig-sdk/chuck-norris-jokes` |
| Golang | `github.com/voxgig-sdk/chuck-norris-jokes-sdk/go` | `go get github.com/voxgig-sdk/chuck-norris-jokes-sdk/go` |
| Ruby | `voxgig-sdk-chuck-norris-jokes` | `gem install voxgig-sdk-chuck-norris-jokes` |
| Lua | `voxgig-sdk-chuck-norris-jokes` | `luarocks install voxgig-sdk-chuck-norris-jokes` |
...
- Upstream API: [https://api.chucknorris.io/](https://api.chucknorris.io/)
