...
A free JSON API for hand curated Chuck Norris facts, including random jokes and categories.

Learn more about Chuck Norris Jokes API at [api.chucknorris.io](https://api.chucknorris.io/).
...
This SDK exposes the API as a small set of **semantic entities** — Category, Joke and Search — that you
...
| --- | --- | --- |
| **Category** | The Category entity (list). | `/jokes/categories` |
| **Joke** | The Joke entity (list). | `/jokes/random` |
| **Search** | The Search entity (list). | `/jokes/search` |
