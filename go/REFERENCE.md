# ChuckNorrisJokes Golang SDK Reference

Complete API reference for the ChuckNorrisJokes Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *ChuckNorrisJokesSDK`
...
#### `Category(data map[string]any) ChuckNorrisJokesEntity`

Create a new `Category` entity instance. Pass `nil` for no initial data.

#### `Joke(data map[string]any) ChuckNorrisJokesEntity`

Create a new `Joke` entity instance. Pass `nil` for no initial data.

#### `Search(data map[string]any) ChuckNorrisJokesEntity`
