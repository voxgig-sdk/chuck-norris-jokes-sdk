...
type ChuckNorrisJokesSDK struct {
	Mode     string
...
func (sdk *ChuckNorrisJokesSDK) OptionsMap() map[string]any {
...
func (sdk *ChuckNorrisJokesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ChuckNorrisJokesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ChuckNorrisJokesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ChuckNorrisJokesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ChuckNorrisJokesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ChuckNorrisJokesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ChuckNorrisJokesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ChuckNorrisJokesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ChuckNorrisJokesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ChuckNorrisJokesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ChuckNorrisJokesSDK {
	...
	sdk := NewChuckNorrisJokesSDK(sdkopts)
	sdk.Mode = "test"
