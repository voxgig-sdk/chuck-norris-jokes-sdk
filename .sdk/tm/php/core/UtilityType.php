...
// ChuckNorrisJokes SDK utility type

class ChuckNorrisJokesUtility
{
    ...
    public static function copy(ChuckNorrisJokesUtility $src): ChuckNorrisJokesUtility
    {
        $u = new ChuckNorrisJokesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
