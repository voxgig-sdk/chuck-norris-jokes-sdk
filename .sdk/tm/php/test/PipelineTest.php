...
// ChuckNorrisJokes SDK pipeline test
//
...
{
    private static function utility(): ChuckNorrisJokesUtility
    {
        return new ChuckNorrisJokesUtility();
    }
    ...
    private static function ctx(array $over = []): ChuckNorrisJokesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ChuckNorrisJokesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ChuckNorrisJokesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ChuckNorrisJokesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ChuckNorrisJokesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ChuckNorrisJokesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ChuckNorrisJokesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ChuckNorrisJokesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ChuckNorrisJokesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ChuckNorrisJokesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ChuckNorrisJokesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ChuckNorrisJokesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ChuckNorrisJokesResponse([]),
            'result' => new ChuckNorrisJokesResult([]),
        ]);
        [, $err] = ChuckNorrisJokesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ChuckNorrisJokesSpec([]),
            'response' => null,
            'result' => new ChuckNorrisJokesResult([]),
        ]);
        [, $err] = ChuckNorrisJokesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ChuckNorrisJokesSpec(['step' => 's']),
            'response' => new ChuckNorrisJokesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ChuckNorrisJokesResult([]),
        ]);
        [, $err] = ChuckNorrisJokesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ChuckNorrisJokesSpec(['step' => 's']),
            'response' => new ChuckNorrisJokesResponse(self::resp(200, ['v' => 1])),
            'result' => new ChuckNorrisJokesResult([]),
        ]);
        [, $err] = ChuckNorrisJokesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ChuckNorrisJokesSpec(['step' => 's']),
            'response' => new ChuckNorrisJokesResponse(self::resp(200, ['v' => 2])),
            'result' => new ChuckNorrisJokesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ChuckNorrisJokesMakeResponse::call($ctx);
    ...
    {
        $preset = new ChuckNorrisJokesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ChuckNorrisJokesSpec([]),
            'response' => new ChuckNorrisJokesResponse([]),
            'result' => new ChuckNorrisJokesResult([]),
        ...
        [$got, $err] = ChuckNorrisJokesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ChuckNorrisJokesResult([])]);
        [, $err] = ChuckNorrisJokesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ChuckNorrisJokesSpec([]), 'result' => null]);
        [, $err] = ChuckNorrisJokesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ChuckNorrisJokesSpec(['step' => 's']),
            'result' => new ChuckNorrisJokesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ChuckNorrisJokesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ChuckNorrisJokesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ChuckNorrisJokesSpec(['step' => 's']),
            'result' => new ChuckNorrisJokesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ChuckNorrisJokesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ChuckNorrisJokesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ChuckNorrisJokesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ChuckNorrisJokesSpec([]),
            'result' => new ChuckNorrisJokesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ChuckNorrisJokesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ChuckNorrisJokesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ChuckNorrisJokesError('boom', 'boom');
        $utility->fetcher = function (ChuckNorrisJokesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ChuckNorrisJokesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ChuckNorrisJokesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ChuckNorrisJokesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ChuckNorrisJokesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ChuckNorrisJokesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ChuckNorrisJokesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ChuckNorrisJokesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ChuckNorrisJokesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ChuckNorrisJokesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ChuckNorrisJokesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ChuckNorrisJokesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ChuckNorrisJokesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ChuckNorrisJokesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ChuckNorrisJokesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ChuckNorrisJokesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ChuckNorrisJokesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ChuckNorrisJokesResult(['ok' => false])]);
        $this->expectException(ChuckNorrisJokesError::class);
        ChuckNorrisJokesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ChuckNorrisJokesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ChuckNorrisJokesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ChuckNorrisJokesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ChuckNorrisJokesBaseFeature();
        $b = new ChuckNorrisJokesBaseFeature();
        ChuckNorrisJokesFeatureAdd::call($ctx, $a);
        ChuckNorrisJokesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ChuckNorrisJokesBaseFeature
    {
        $f = new ChuckNorrisJokesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ChuckNorrisJokesFeatureAdd::call($ctx, self::named_feature('a'));
        ChuckNorrisJokesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ChuckNorrisJokesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ChuckNorrisJokesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ChuckNorrisJokesFeatureAdd::call($ctx, $replace);
        ...
        ChuckNorrisJokesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ChuckNorrisJokesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ChuckNorrisJokesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ChuckNorrisJokesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ChuckNorrisJokesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ChuckNorrisJokesResponse(['headers' => null]),
            'result' => new ChuckNorrisJokesResult([]),
        ]);
        ChuckNorrisJokesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ChuckNorrisJokesResultBody::call($ctx);
