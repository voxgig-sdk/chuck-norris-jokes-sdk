...
// ChuckNorrisJokes SDK clienttrack feature
...
class ChuckNorrisJokesClienttrackFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    public function PostConstruct(ChuckNorrisJokesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ChuckNorrisJokes-SDK';
