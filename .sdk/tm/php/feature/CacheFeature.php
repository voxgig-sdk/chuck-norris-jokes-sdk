...
// ChuckNorrisJokes SDK cache feature
...
class ChuckNorrisJokesCacheFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    private function _through(ChuckNorrisJokesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
