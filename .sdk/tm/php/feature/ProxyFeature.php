...
// ChuckNorrisJokes SDK proxy feature
...
class ChuckNorrisJokesProxyFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    public function init(ChuckNorrisJokesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ChuckNorrisJokesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
