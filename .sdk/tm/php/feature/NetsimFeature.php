...
// ChuckNorrisJokes SDK netsim feature
...
class ChuckNorrisJokesNetsimFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    private function _simulate(ChuckNorrisJokesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ChuckNorrisJokesContext $ctx, array $applied): void
    {
        $client = $this->client;
