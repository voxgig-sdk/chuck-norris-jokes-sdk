...
// ChuckNorrisJokes SDK telemetry feature
...
class ChuckNorrisJokesTelemetryFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    private function _close(ChuckNorrisJokesContext $ctx, bool $ok): void
    {
