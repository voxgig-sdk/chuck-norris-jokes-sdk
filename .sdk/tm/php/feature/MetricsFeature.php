...
// ChuckNorrisJokes SDK metrics feature
...
class ChuckNorrisJokesMetricsFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    private function _record(ChuckNorrisJokesContext $ctx, bool $ok): void
    {
