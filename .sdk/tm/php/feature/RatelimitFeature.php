...
// ChuckNorrisJokes SDK ratelimit feature
...
class ChuckNorrisJokesRatelimitFeature extends ChuckNorrisJokesBaseFeature
{
    ...
    private function _acquire(ChuckNorrisJokesContext $ctx): void
    {
    ...
    private function _track(ChuckNorrisJokesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
