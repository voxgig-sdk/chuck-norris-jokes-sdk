...
// ChuckNorrisJokes SDK utility: make_options

class ChuckNorrisJokesMakeOptions
{
    ...
    public static function call(ChuckNorrisJokesContext $ctx): array
    {
        ...
        //
        // `ChuckNorrisJokesSchema::optspec()` is built from the model:
        ...
        $optspec = ChuckNorrisJokesSchema::optspec();
