...
class ChuckNorrisJokesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ChuckNorrisJokesTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ChuckNorrisJokesTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ChuckNorrisJokesTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
