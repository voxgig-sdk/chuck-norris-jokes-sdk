...
describe('exists', async () => {
  ...
  //
  // ChuckNorrisJokesSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof ChuckNorrisJokesSDK, true,
      'ChuckNorrisJokesSDK.test() must return a client synchronously')
  })
