...
|---|---|---|
| `ts/` | @voxgig-sdk/chuck-norris-jokes-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/chuck-norris-jokes-sdk \
      --repository voxgig-sdk/chuck-norris-jokes-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/chuck-norris-jokes-sdk` shows it, and
`npm trust revoke @voxgig-sdk/chuck-norris-jokes-sdk --id=<id>` removes it.
